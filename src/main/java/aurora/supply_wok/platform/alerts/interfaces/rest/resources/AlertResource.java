...
@Schema(
    ...
    example = "{\"id\": 1, \"severity\": \"CRITICAL\", \"detail\": \"Sensor value exceeded limit.\", \"status\": \"UNREAD\", \"createdAt\": \"2026-06-19T03:30:00.000+00:00\", \"alertType\": \"RESTAURANT\", \"sensorId\": 1, \"sensorName\": \"Kitchen Temp Sensor\"}"
)
public record AlertResource(
    ...
    @Schema(description = "Alert status", example = "UNREAD")
    String status,
