...
public record RegisterStockWriteOffCommand(Long itemId, SupplierId supplierId, double amount, LocalDateTime date, String reason) {

    public RegisterStockWriteOffCommand {
        if(itemId==null)
        {
